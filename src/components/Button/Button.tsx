...
import { View, ActivityIndicator, Size, Text, useStyleSheet, ViewProps, ColorNames } from 'wiloke-react-core';
...
const Button = forwardRef<HTMLElement, ButtonProps>(
  (
    ...
    const renderChildren = () => {
      return (
        <>
          {loading && <ActivityIndicator color={loadingColor} size={18} className={styles(css.loading)} />}
    ...
    return (
      <View tagName="button" ref={ref as Ref<HTMLButtonElement>} color={color} backgroundColor={backgroundColor} type={type} {...props}>
        {renderChildren()}
      </View>
    );
  },
